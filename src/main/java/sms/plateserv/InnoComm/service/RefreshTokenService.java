...
import sms.plateserv.InnoComm.exception.TokenRefreshException;
import sms.plateserv.InnoComm.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
	...
	public Optional<RefreshToken> findByToken(String token) {
		LOGGER.debug("Refresh Token is {}", token);
	...
	public RefreshToken save(RefreshToken refreshToken) {
		LOGGER.debug("Refresh token to be saved is {}", refreshToken);
	...
	public RefreshToken createRefreshToken() {
		...
		LOGGER.debug("Created refresh token is {}", refreshToken);
		return refreshToken;
	}
